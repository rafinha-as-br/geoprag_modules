...
/// Contrato de acesso ao ponto de aplicação (trecho) atribuído ao aplicador
/// logado no `aplicador_app`.
///
...
abstract class PontoDeAplicacaoRepository {
  ...
  /// Captura a localização GPS atual do dispositivo para (re)marcar o ponto
  /// inicial do trecho (usado em `MarcacaoDoPontoScreen`).
  ///
