export 'core/denuncia_de_foco.dart';
export 'core/denuncia_de_foco_repository.dart';

export 'data/mock_denuncias_de_foco.dart';
export 'data/denuncia_de_foco_repository_impl.dart';
...
export 'presentation/tela_educativa_screen.dart';
