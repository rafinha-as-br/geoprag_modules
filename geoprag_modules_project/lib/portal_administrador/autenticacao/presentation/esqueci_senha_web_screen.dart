...
class _EsqueciSenhaWebScreenState extends State<EsqueciSenhaWebScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AdminEsqueciSenhaCubit, AuthActionState<AdminRole>>(
      ...
      builder: (context, state) {
        final isLoading = state is AuthActionLoading<AdminRole>;
        return BaseAuthStepScreen(
          ...
          actionLabel: 'Solicitar redefinição',
          isLoading: isLoading,
          onAction: isLoading ? null : _prosseguir,
        );
      },
    );
  }
