      ...
      body: Padding(
        ...
        child: BlocBuilder<AplicadorDetalheCubit, AplicadorDetalheState>(
          builder: (context, state) {
            final aplicador = state is AplicadorDetalheLoaded
                ? state.aplicador
                : null;

            return BaseDetailScreen(
              variant: BaseDetailScreenVariant.duasColunas,
              title: aplicador?.nome ?? '',
              isLoading: state is AplicadorDetalheLoading,
              errorMessage: state is AplicadorDetalheError
                  ? 'Não foi possível carregar o aplicador: ${state.message}'
                  : null,
              actions: aplicador == null
                  ? const []
                  : [
                      ElevatedButton.icon(
                        onPressed: () {},
              ...
              contentBuilder: (context) => aplicador == null
