/// Bounding box do trecho hidrológico do município (tenant), usado para
...
/// Identidade visual (branding) do tenant exibida nos dois portais
/// (`portal_administrador` e `aplicador_app`).
...
///
/// Entidade compartilhada entre `portal_administrador` e `aplicador_app`
/// (ver seção 1.1 do guia de arquitetura) — os dois portais consomem o
/// mesmo conceito de tenant e não devem redefinir modelos equivalentes em
/// seus respectivos `core/`.
class TenantConfig {
