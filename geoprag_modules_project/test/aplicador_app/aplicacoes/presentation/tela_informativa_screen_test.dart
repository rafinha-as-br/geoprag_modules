...
import 'package:geoprag_modules/aplicador_app/aplicacoes/presentation/tela_informativa_screen.dart';
  ...
  Widget wrap() {
    return MaterialApp(
      home: AplicadorNavigatorScope(
        navigator: navigator,
        child: const TelaInformativaScreen(pontoId: 'pa1'),
      ),
    );
  }

  testWidgets('mostra título, explicação e aciona toAplicacaoGeo com o pontoId', (
    tester,
  ) async {
    ...
    verify(() => navigator.toAplicacaoGeo('pa1')).called(1);
  });
