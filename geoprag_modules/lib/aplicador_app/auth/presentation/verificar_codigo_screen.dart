...
class _VerificarCodigoScreenState extends State<VerificarCodigoScreen> {
            ...
            if (_bloqueado)
              ...
              Align(
                ...
                child: _expirado
                    ? Text(
                        'Código expirado.',
                        style: TextStyle(color: GeopragColors.statusAtrasado, fontWeight: FontWeight.w700),
                      )
                    : GeopragCountdown(key: _timerKey, duration: _duracao, onExpired: _onExpirado),
              ),
  ...
  Widget _buildBloqueado() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        Icon(Icons.lock_clock_outlined, size: 56, color: GeopragColors.statusAtrasado),
        const SizedBox(height: 16),
        Text(
