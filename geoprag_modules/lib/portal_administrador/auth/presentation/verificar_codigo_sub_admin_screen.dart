...
class VerificarCodigoSubAdminScreen extends StatefulWidget {
  ...
  @override
  State<VerificarCodigoSubAdminScreen> createState() => _VerificarCodigoSubAdminScreenState();
}

class _VerificarCodigoSubAdminScreenState extends State<VerificarCodigoSubAdminScreen> {
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                if (_expirado)
                  OutlinedButton(
                    onPressed: () => Navigator.pushNamed(context, '/senha/aguardando'),
