...
class DashboardAplicadoresScreen extends StatelessWidget {
                        ...
                        children: [
                          ...
                          Table(
                            ...
                            children: [
                              ...
                              _buildTableRow(context, 'João Silva', 'Belchior Alto', 'Ativo', Colors.green),
                              _buildTableRow(context, 'Maria Souza', 'Gasparinho', 'Desativado', Colors.grey),
                              _buildTableRow(context, 'José Mendes', 'Bateias', 'Ativo', Colors.green),
                            ],
                          ),
                        ],
                      ),
  ...
  TableRow _buildTableRow(BuildContext context, String nome, String bairro, String status, Color statusColor) {
    return TableRow(
      children: [
